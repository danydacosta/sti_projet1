                            ...
                            foreach($messages as $row) {
                                ...
                                echo '<tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" onclick="if (confirm(\'Supprimer le message ?\')){ window.location.href = \'/index.php?del='.$row['id'].'\'; }else{event.stopPropagation(); event.preventDefault();};">
